\blfootnote{ 1 UNIC, CNRS Gif sur Yvette, France}
\blfootnote{ * correspondance : zerlaut@unic.cnrs-gif.fr}

#+LaTeX_HEADER: \def\shorttitle{Scientific papers with Org-Mode= and \LATEX}
