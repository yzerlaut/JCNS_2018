...
amet ipsum. Nunc quis urna dictum turpis accumsan semper., where we
reference to the results section[[sec:results]] and more precisely to its
subsectoin[[sec:section1]]. And also to Equation [[eq:first]] and Figure [[fig:1]]
and by referencing to [[citetext:Tuckwell2002]] with two possible citation
formats : either within the text as [[citetext:Destexhe2003]] or with
parentheses [[cite:Destexhe2003,Chance2002]] as commonly used in biology
journals.
