...
desisive tool in the exploration of how neural population dynamics
...
sheet. We first show that this simple model accuratly predicts the
...
vivo/, our study therefore proposes that the the horizontal fibre
network combined with the strongly sublinear relation between membrane
